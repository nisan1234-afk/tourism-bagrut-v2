(function () {
  var API = 'https://script.google.com/macros/s/AKfycbwf3-MNZBBi64zXcNH7wfhBRoEBl9brtQ9QRI4Won5RmUIOrl_WBivN6uI5NAp6Mc0h/exec';
  ...
  fetch(API, { method: 'POST', body: JSON.stringify({ action: 'getContentOverrides', unit_id: unitId }) })
    ...
    .catch(function () { /* שקט — נשאר הטקסט המקורי אם הטעינה נכשלה */ });
}());
