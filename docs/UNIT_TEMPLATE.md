...
**כרטיס המוכנות** (`#unitHome`, "המאמן האישי / המוכנות שלי") מצויר על ידי המנוע בראש הדף הראשון של כל יחידה,
בלי שום HTML בדף: המשימה הבאה (הדף הראשון שלא הושלם), אחוז, ושלושה סימנים אחידים: להבין את האזור (כל דפי התוכן),
